...
char userid[20];
pw_widget toplevel, root3_screen ,butt_root3_try, butt_root3_back;
...
void keeper_enroll_root3()
{
	...
	char keeper[20] = {"shopkeeper"};
	int retval = keeper_enroll_root3_extra(userid,keeper);
...
//page graphics begin
	...
	root3_label[1] = pw_create_label(root3_screen, 20, 55, 120, 40,
	...
	root3_label[2] = pw_create_label(root3_screen, 100, 120, 100, 40,
	...
	rb_benificary_root3 = pw_create_radiobutton(root3_screen,50, 120, 20, 20, NULL, 
			PW_BGCOLOR, GREY, 
			PW_FONT, PW_BOLD_FONT, 
			PW_FGCOLOR, "white", 
			PW_TEXT, "",
	...
	butt_root3_try = pw_create_button(root3_screen, 110, 180, 80,20,
...
///////////////////////////////////////////we need to change the functionality of the button under here later ryt now it takes to home
	butt_root3_back = pw_create_button(root3_screen, 15, 180, 80,20,
                        PW_ACTIVE_IMAGE, "/root/PDS/back.png",
                        PW_NORMAL_IMAGE, "/root/PDS/back.png",
                        PW_CALLBACK, PW_BUTTON_RELEASE_EVENT, cb_root3_back,
                        PW_CONFIG_END);

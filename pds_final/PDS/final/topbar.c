...
//page graphics begin
	...
	sale_label[1] = pw_create_label(splash_screen, 20, 60, 120, 40,
...
///////////////////////////////////////////we need to change the functionality of the button under here later ryt now it goes to home
	Butt_splash_home = pw_create_button(splash_screen, 15, 180, 50,18,
